          ...
          {akashaLineup.map((artist, index) => (
            <ScrollReveal key={artist.name} delay={index * 55}>
              ...
              >
                ...
                <span className="akasha-display relative z-10 text-[clamp(2.8rem,7.7vw,8rem)] font-black uppercase leading-[0.78] tracking-[-0.075em] text-[#e9e5d8] transition-transform duration-500 ease-[cubic-bezier(.16,1,.3,1)] group-hover:translate-x-3 group-hover:text-white">{artist.name}</span>
