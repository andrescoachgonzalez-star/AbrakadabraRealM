...
const pillars = [
  {
    ...
    title: "Luxury & Craft",
    description:
      "Every piece we create is a testament to artisan excellence. From Colombian emeralds to bespoke jewelry, we merge centuries of tradition with bold modern design.",
  },
  {
    icon: Heart,
    title: "Spirituality & Art",
    description:
      "Art is the bridge between the visible and the invisible. Through abstract expression, we capture the essence of the soul and transform it into something tangible.",
  },
  {
    icon: Sparkles,
    title: "Music & Energy",
    description:
      "Music makes us better than we truly are. Our artists, DJs, and producers channel cosmic energy into soundscapes that elevate consciousness.",
  },
  {
    icon: Globe,
    title: "Global Vision",
    description:
      "Rooted in Colombia, alive in Miami, reaching Spain and beyond. Abrakadabra Realm is a borderless movement uniting cultures through beauty and purpose.",
  },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {pillars.map((pillar, index) => {
            ...
            return (
              <div
                key={pillar.title}
                className={`glass rounded-2xl p-8 group hover:border-primary/30 transition-all duration-700 ${
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div
              className="absolute -bottom-4 -left-4 w-32 h-32 rounded-full bg-secondary/10 blur-2xl animate-glow-pulse"
          ...
          >
            ...
            <div className="flex gap-8 mb-8">
              <div>
                ...
                <div className="text-muted-foreground text-sm font-mono">Free Forever</div>
              </div>
              <div className="w-px bg-border" />
              <div>
                <div className="font-serif text-3xl font-bold text-foreground">6+</div>
                <div className="text-muted-foreground text-sm font-mono">Courses</div>
              </div>
              <div className="w-px bg-border" />
              <div>
                <div className="font-serif text-3xl font-bold text-foreground">0</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course, index) => {
            ...
            return (
              ...
              >
                <div className="absolute top-4 right-4 bg-primary/15 text-primary text-xs font-mono tracking-widest px-3 py-1 rounded-full border border-primary/20">
                  {course.tag}
                </div>
...
function ShowcaseItem({ item, reversed }: { item: (typeof showcaseItems)[0]; reversed: boolean }) {
  ...
  return (
    <div ref={ref} id={item.id} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div
        className={`relative ${reversed ? "lg:order-2" : ""} transition-all duration-1000 ${
          isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
        }`}
      >
    ...
    <section className="relative py-16 px-6">
      <div className="max-w-7xl mx-auto flex flex-col gap-32">
        {showcaseItems.map((item, i) => (
          <ShowcaseItem key={item.id} item={item} reversed={i % 2 !== 0} />
        ))}
      </div>
    </section>
  )
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {team.map((member, index) => (
            <div
              key={member.name}
              className={`glass rounded-2xl p-8 text-center group hover:border-primary/20 transition-all duration-700 ${
                isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
              }`}
              style={{ transitionDelay: `${index * 150}ms` }}
            >
              ...
              <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
                ...
                <span className="font-mono tracking-wider">{member.country}</span>
              </div>
            </div>
          ))}
        </div>
  ...
  return (
    <section ref={sectionRef} id="cta" className="relative py-32 px-6">
      <div className="max-w-4xl mx-auto">
        <div
          className={`glass-accent rounded-3xl p-12 md:p-16 text-center relative overflow-hidden transition-all duration-1000 ${
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground">
              ...
              >
                ...
                <span className="font-mono">@abrakadabrarealm</span>
              </a>
              <a
              ...
              >
                ...
                <span className="font-mono">abrakadabrarealm@gmail.com</span>
              </a>
              <a
