      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-12">
        ...
        >
          ...
          <div className="absolute -left-4 top-1/4 animate-float animation-delay-300">
            <div className="rounded-full bg-card px-3 py-1.5 shadow-lg border border-border">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            The <span className="font-semibold text-foreground">Abrakadabra Realm</span> team is crafting something extraordinary for this section. We{"'"}re putting all our magic into it!
          </p>
        ...
        >
          <Link
            href="/"
            className="group inline-flex items-center gap-3 rounded-full bg-foreground px-8 py-4 text-sm font-semibold tracking-wider text-background transition-all duration-300 hover:gap-4 hover:shadow-xl hover:shadow-foreground/10 hover:scale-105"
          >
        ...
        >
          ...
          <div className="h-1.5 w-full overflow-hidden rounded-full bg-muted">
            <div className="h-full w-3/4 rounded-full bg-gradient-to-r from-primary to-primary/60 animate-[pulse_2s_ease-in-out_infinite]" />
          </div>
        </div>
